  ...
  return (
    <div className="product flex flex-col gap-2 bg-white shadow-md rounded-xl overflow-hidden hover:shadow-2xl">
      <div className="img flex justify-center">
        <img src={product.image} alt="{product.name}" className="h-[12rem]" />
      </div>
      <div className="texts  flex flex-col gap-2 px-5 pb-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className=" uppercase bg-gradient-to-r from-blue-500 via-blue-700 to-blue-900 uppercase bg-violet-500 text-violet-50 font-medium py-3 px-10 rounded-md"
          >   
            Add to cart
          </button>
        </div>
